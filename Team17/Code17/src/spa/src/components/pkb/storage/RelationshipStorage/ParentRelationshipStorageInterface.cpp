...
ParentRelationshipStorageInterface::ParentRelationshipStorageInterface(RelationshipType relationshipType) : RelationshipStorage(), relationshipType(relationshipType) {}
