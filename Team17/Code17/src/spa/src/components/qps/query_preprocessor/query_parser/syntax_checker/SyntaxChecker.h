...
protected:
    ...
    std::unordered_map<TokenType, std::vector<TokenType>>  generalSyntax = {
        ...
        {TokenType::RELREF, std::vector<TokenType>{TokenType::FOLLOWS, TokenType::FOLLOWS_T, TokenType::PARENT, TokenType::PARENT_T, TokenType::USES, TokenType::MODIFIES, TokenType::CALLS, TokenType::CALLS_T, TokenType::NEXT, TokenType::NEXT_T, TokenType::AFFECTS, TokenType::AFFECTS_T}},
