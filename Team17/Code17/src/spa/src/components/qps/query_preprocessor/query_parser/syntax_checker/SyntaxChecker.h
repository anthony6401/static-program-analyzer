...
protected:
    ...
    std::unordered_map<TokenType, std::vector<TokenType>>  generalSyntax = {
        ...
        {TokenType::STMTREF, std::vector<TokenType>{TokenType::SYNONYM, TokenType::UNDERSCORE, TokenType::INTEGER}},
        {TokenType::ENTREF, std::vector<TokenType>{TokenType::SYNONYM, TokenType::UNDERSCORE, TokenType::NAME_WITH_QUOTATION}},
