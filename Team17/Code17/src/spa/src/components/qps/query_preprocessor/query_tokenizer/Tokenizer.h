...
private:
  ...
  void validateTupleValueHandler(std::string &currString,
                                 std::string &currValue, size_t commaIndex,
                                 bool &returnFalse);
  std::vector<std::string>
  convertExpressionToStringVector(const std::string &s);
  bool validateExpression(std::vector<std::string> expressionVector);
  void symbolsFoundHandler(std::string &temp,
                           std::vector<std::string> &expressionTokens,
                           bool &isInvalidExpression);
  void characterInExpressionHandler(char character, std::string &temp,
                                    std::vector<std::string> &expressionTokens,
                                    bool &isInvalidExpression);
  void
  nonBracketInExpressionVectorHandler(std::string &string, std::string &prev,
                                      bool &isPrevName, bool &isPrevInteger,
                                      std::stack<std::string> &expressionStack,
                                      bool &returnFalse);
  void stringInExpressionVectorHandler(std::string &string, std::string &prev,
                                       bool &isPrevName, bool &isPrevInteger,
                                       std::stack<std::string> &expressionStack,
                                       bool &returnFalse);
