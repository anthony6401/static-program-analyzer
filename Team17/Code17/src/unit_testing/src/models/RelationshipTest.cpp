...
TEST_CASE("Next Relationship Test") {
    ...
    Relationship* whileReadRel = new NextRelationship(whileEntity, readEntity);
    Relationship* whilePrintRel = new NextRelationship(whileEntity, printEntity);
    Relationship* whileCallRel = new NextRelationship(whileEntity, callEntity);
    Relationship* whileWhileRel = new NextRelationship(whileEntity, whileEntity2);
    Relationship* whileIfRel = new NextRelationship(whileEntity, ifEntity);
    ...
    Relationship* ifAssignRel = new NextRelationship(ifEntity, assignEntity);
    Relationship* ifReadRel = new NextRelationship(ifEntity, readEntity);
    Relationship* ifPrintRel = new NextRelationship(ifEntity, printEntity);
    Relationship* ifCallRel = new NextRelationship(ifEntity, callEntity);
    Relationship* ifWhileRel = new NextRelationship(ifEntity, whileEntity);
    Relationship* ifIfRel = new NextRelationship(ifEntity, ifEntity2);
