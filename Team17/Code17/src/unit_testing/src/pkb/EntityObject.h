...
static Entity* printEntity = new PrintEntity(print_value_one);
...
static Entity* printEntityTwo = new PrintEntity(print_value_two);
...
static Entity* printEntityThree = new PrintEntity(print_value_three);
...
static Entity* printEntityDuplicate = new PrintEntity(print_value_one);
static Entity* procedureEntityDuplicate = new ProcedureEntity(procedure_value_one);
static Entity* readEntityDuplicate = new ReadEntity(read_value_one);
...
static Entity* callEntityTwoDuplicate = new CallEntity(call_value_two);
...
static Entity* printEntityTwoDuplicate = new PrintEntity(print_value_two);
static Entity* procedureEntityTwoDuplicate = new ProcedureEntity(procedure_value_two);
static Entity* readEntityTwoDuplicate = new ReadEntity(read_value_two);
...
static Entity* callEntityThreeDuplicate = new CallEntity(call_value_three);
...
static Entity* printEntityThreeDuplicate = new PrintEntity(print_value_three);
static Entity* procedureEntityThreeDuplicate = new ProcedureEntity(procedure_value_three);
static Entity* readEntityThreeDuplicate = new ReadEntity(read_value_three);
